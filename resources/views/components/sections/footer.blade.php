    ...
    <div class="mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                {{-- <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="/resources/starter-kit" class="hover:underline">Kit de démarrage</a>
                        </li>
                        <li>
                            <a href="/resources/videos" class="hover:underline">Vidéos</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            {{-- <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-youtube w-5 h-5"
                        viewBox="0 0 24 24" aria-hidden="true" stroke-width="1.5" stroke="currentColor" fill="none"
